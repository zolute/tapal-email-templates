						...
						<tbody>
								...
								<td bgcolor="white"
									...
									<h2
										...
										<img data-imagetype="Empty" data-imageerror="SrcNullOrEmpty"
											...
											style="background-color:transparent;font-weight: 600;color: white;">Missed
											call</span><br>
							...
							<tr class="">
								<td bgcolor="#ffffff" class=""
									style="padding:10px 20px 10px 20px; font-family:&quot;Open Sans&quot;,sans-serif; color:rgb(85,85,85)">
									<div class=""
										...
										went unanswered and left no voicemail message. The caller was&nbsp;<span
											class="" style="font-weight:700"><? GetFromName(); ?> <? GetAni(); ?> </span>.</div>
								</td>
							</tr>
